<div id="sidebar_right">
    ...
    <?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Sidebar Right')) : else : ?>
    	...
    	<ul>
						...
						<li>&nbsp;</li>
						<li>We designed iFeature Pro to be as user friendly as possible, if you do run into trouble we provide a <a href="http://cyberchimps.com/forum">free support forum</a>, and <a href="http://www.cyberchimps.com/neuropro/docs/">precise documentation</a>.</li>
						<li>&nbsp;</li>
