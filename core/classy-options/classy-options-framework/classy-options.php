...
<p><img src="<?php echo get_template_directory_uri() ;?>/images/chimp.png" alt="CyberChimps" /><strong><?php echo $themenamefull; ?> has successfully been installed.</strong> Want more features? <a href="http://cyberchimps.com/neuropro/" target="_blank">Learn more about upgrading to <?php echo $themenamefull; ?> Pro.</a>
<span class="twitter">
