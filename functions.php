...
new WPUpdatesThemeUpdater( 'http://wp-updates.com/api/1/theme', 347, basename( get_template_directory() ) );
...
function cyberchimps_options_help_sub_header(){
	$text = __( 'Neuro Pro 3 an Elegant and Responsive Wordpress Theme', 'cyberchimps' );
	return $text;
}
...
add_action( 'cyberchimps_slide_pro_img1', 'cyberchimps_slide_pro_img1', 10 );
...
add_action( 'cyberchimps_slide_pro_img2', 'cyberchimps_slide_pro_img2', 10 );
...
add_action( 'cyberchimps_slide_pro_img3', 'cyberchimps_slide_pro_img3', 10 );
 ...
 * @return array
 */
function cyberchimps_typography_faces( $fonts ) {
    $new_font = array(
...
add_filter( 'cyberchimps_typography_faces', 'cyberchimps_typography_faces', 10, 1 );
